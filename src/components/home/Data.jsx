...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title"> Agie Nugroho
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I'm Mathematics Student of Jenderal Soedirman University.
        Math and Programming are my Goals.</p>
